...
/* the thing that makes the normal print function inefficient is that it prints at the end of a line, this implementation prints at the end of a block */
#define PRINT_BLOCK_LENGTH 256
