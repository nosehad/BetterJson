...
namespace betterJson
{
    ...
    {
    public:
        JsonObject(std::string *key, JsonValue value) : key(key),
                                                        value(value){};
    ...
    {
    public:
        JsonElement(JsonValue value) : value(value){};
    ...
    private:
        ...
        inline char *
        getkey(const std::string *str) const noexcept
        {
        ...
        inline JsonObject*
        getObject(char *raw_value, std::string *key) const
        {
            if (raw_value == null)
    ...
    public:
        ...
        add(const std::pair<std::string, int> &add) noexcept
        {
            ...
            sqtr_setNoCopy(this->json, this->getkey(&(add.first)), value);
        }
        ...
        {
            sqtr_setNoCopy(this->json, this->getkey(&(add.first)), (char *)add.second.c_str());
        }
    ...
    private:
        ...
        inline JsonElement *
        getObject(char *raw_value, unsigned int index) const
        {
            if (raw_value == null)
    ...
    public:
        ...
        /**
         * @brief searches for element at <index>
         * @param index position in array
         *
         * @return value of the Element belonging to <index>
         */
        JsonElement *
        get(unsigned int index)
        {
            if (index > this->array->size)
                throw new JsonArrayOutOfBoundsException(std::string("Attempt to access array with length " + this->array->size) + std::string(" at index " + index) + ".");
            char *raw_value = (char *)svect_get(this->array, index);
            return this->getObject(raw_value, index);
        }
         ...
         */
        inline void
        add(const int add) noexcept
        {
            char *value = (char *)malloc(MAX_LENGTH_INT + 1);
            convert_IntToCStr(add, value);
            svect_insert(this->array, value);
        }
         ...
         */
        inline void
        add(const unsigned int &add) noexcept
        {
            char *value = (char *)malloc(MAX_LENGTH_UINT + 1);
            convert_UIntToCStr(add, value);
            svect_insert(this->array, value);
        }
         ...
         */
        inline void
        add(const long long &add) noexcept
        {
            char *value = (char *)malloc(MAX_LENGTH_LONG + 1);
            convert_LongToCStr(add, value);
            svect_insert(this->array, value);
        }
         ...
         */
        inline void
        add(const unsigned long long &add) noexcept
        {
            char *value = (char *)malloc(MAX_LENGTH_ULONG + 1);
            convert_ULongToCStr(add, value);
            svect_insert(this->array, value);
        }
         ...
         */
        inline void
        add(const double &add) noexcept
        {
            char *value = (char *)malloc(MAX_LENGTH_FLOAT + 1);
            convert_DoubleToCStr(add, value);
            svect_insert(this->array, value);
        }
         ...
         */
        inline void
        add(const float &add) noexcept
        {
            char *value = (char *)malloc(MAX_LENGTH_FLOAT + 1);
            convert_FloatToCStr(add, value);
            svect_insert(this->array, value);
        }
         ...
         */
        inline void
        add(const std::string &add) noexcept
        {
            svect_insert(this->array, (char *)add.c_str());
        }
         ...
         */
        std::string *
        getString(const unsigned int index) const
        {
            char *value = (char *)svect_get(this->array, index);
         ...
         */
        int
        getInt(const unsigned int index) const
        {
            char *value = (char *)svect_get(this->array, index);
            return convert_CStrToInt(value + 1);
        }
        ...
        /**
         * @brief get corresponding value at index
         *
         * @param key
         * @return value at index as unsigned integer
         */
        unsigned int
        getUInt(const unsigned int index) const
        {
            char *value = (char *)svect_get(this->array, index);
         ...
         *
         * @param key
         * @return value at index as 64 bit integer
         */
        long long
        getLong(const unsigned int index) const
        {
            char *value = (char *)svect_get(this->array, index);
         ...
         *
         * @param key
         * @return value at index as unsigned 64 bit integer
         */
        unsigned long long
        getULong(const unsigned int index) const
        {
            char *value = (char *)svect_get(this->array, index);
         ...
         */
        float
        getFloat(const unsigned int index) const
        {
            char *value = (char *)svect_get(this->array, index);
         ...
         */
        double
        getDouble(const unsigned int index) const
        {
            char *value = (char *)svect_get(this->array, index);
